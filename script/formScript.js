...
function createForm() {
    form = createElemUtil("container", "courses_form", "courses_form", "form");

    formWrapper = createElemUtil(form.id, "form_wrapper", "form_wrapper", "div");
    ...
    ccodeInput.placeholder = "Enter course's code";
    ...
    tseatsInput.placeholder = "Enter total seats";
    ...
    cseatsInput.placeholder = "Enter current available seats";
    ...
    cnameInput.placeholder = "Enter course's name";
    ...
    inameInput.placeholder = "Enter instructer's name";
    ...
    for (var i =0 ;i <days.length ; i++) {
        ...
        dayTimeInput = createElemUtil(scheduleInputBlock.id, "day_time_input_"+ days[i] + "_" + formIndex, "day_time_input", "input").type = "text";
        dayTimeInput.placeholder = "HHMM-HHMM (24HR)";
        dayTimeInput.maxlength = "10";
    }

    formIndex++;

    createElemUtil(form.id, "course_submit_"+ days[i] + "_" + formIndex, "course_submit", "input").type="submit";
